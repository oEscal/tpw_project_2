# Generated by Django 2.2.6 on 2019-12-08 01:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goals', models.IntegerField(validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.AddField(
            model_name='game',
            name='teams',
            field=models.ManyToManyField(through='api.GameStatus', to='api.Team'),
        ),
        migrations.CreateModel(
            name='Event',
            fields=[
                ...
                ('kind_event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.KindEvent')),
            ],
        ),
        migrations.CreateModel(
            name='PlayerPlayGame',
